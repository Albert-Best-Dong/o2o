 ...
 *  * https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx2ad329334e89a1be&redirect_uri=http://47.104.167.156/o2o/wechatlogin/logincheck&role_type=1&response_type=code&scope=snsapi_userinfo&state=1#wechat_redirect
...
public class WechatLoginController {
	...
	public String doGet(HttpServletRequest request, HttpServletResponse response) {
		...
		if (FRONTEND.equals(roleType)) {
			...
			//20210711 albert shop or shopadmin?
